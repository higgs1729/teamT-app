...
window.CATALOG = [
  ...
  { id: "fbi-wanted", file: "data/simeitehai.html", title: "FBI Wanted リスト", category: "データ・検索系", categoryPath: ["データ・検索系", "事件・捜査"],
    description: "FBI公開指名手配データをカテゴリ別に一覧表示", apiName: "FBI Wanted", apiUrl: "https://www.fbi.gov/wanted/api", icon: "ti-article" },
  { id: "scp-viewer", file: "data/scp_viewer.html", title: "SCP Foundation ターミナル", category: "データ・検索系", categoryPath: ["データ・検索系", "事件・捜査"],
    description: "SCPデータベースから番号を指定して収容記録を閲覧", apiName: "scp-data.tedivm.com", apiUrl: "https://scp-data.tedivm.com/", icon: "ti-browser" },
